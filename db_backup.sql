...
INSERT INTO `articles` VALUES (1,'dcds','dcsdc','1552995392.png',53),(2,'dcc','sdcsdc','1552995398.png',53),(3,'sdcsdc','sdcd','1552995403.jpeg',53),(4,'sdcds','sdcsd','1552995411.png',53),(5,'sdcsc','sdcsdc','1552995420.jpeg',53),(6,'Static Keywordvdvdvdv','Declaring class properties or methods as static makes them accessible without needing an instantiation of the class. A property declared as static cannot be accessed with an instantiated class object (though a static method can).\r\n\r\nFor compatibility with PHP 4, if no visibility declaration is used, then the property or method will be treated as if it was declared as public.','1553064485.jpeg',44);
...
--
-- Dumping data for table `authsystem`
--

LOCK TABLES `authsystem` WRITE;
/*!40000 ALTER TABLE `authsystem` DISABLE KEYS */;
/*!40000 ALTER TABLE `authsystem` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `posts` VALUES (4,'Autoloading Classes','fThe visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member. the class name is used e.g. in call_user_func() then it can contain some dangerous characters such as ../. It is recommended to not use the user-input in such functions or at least verify the input in __autoload().','1552725095.jpeg',43),(5,'Constructors and Destructors','Note: Parent constructors are not called implicitly if the child class defines a constructor. In order to run a parent constructor, a call to parent::__construct() within the child constructor is required. If the child does not define a constructor then it may be inherited from the parent class just like a normal class method (if it was not declared as private).','1552725154.png',43),(6,'Visibility','The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.','1552725376.jpeg',42),(7,'Property Visibility','Class properties must be defined as public, private, or protected. If declared using var, the property will be defined as public.','1552725504.jpeg',42),(8,'Property Visibility','The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.The visibility of a property, a method or (as of PHP 7.1.0) a constant can be defined by prefixing the declaration with the keywords public, protected or private. Class members declared public can be accessed everywhere. Members declared protected can be accessed only within the class itself and by inheriting and parent classes. Members declared as private may only be accessed by the class that defines the member.Class properties must be defined as public, private, or protected. If declared using var, the property will be defined as public.','1552725506.jpeg',42),(10,'The SQL UPDATE Statement','UPDATE table_name\r\nSET column1 = value1, column2 = value2, ...\r\nWHERE condition;','1552903136.jpeg',48),(11,'scsdc','sdcsdcsd','1552921822.jpeg',48),(12,'wwwwwww','sdvhjd akjshdkasd kjsdk uhdkjbad kjhbasd','1552921911.jpeg',48),(13,'Constructors and Destructors','Note: Parent constructors are not called implicitly if the child class defines a constructor. In order to run a parent constructor, a call to parent::__construct() within the child constructor is required. If the child does not define a constructor then it may be inherited from the parent class just like a normal class method (if it was not declared as private).','1552944811.png',49),(14,'Object Inheritance','nheritance is a well-established programming principle, and PHP makes use of this principle in its object model. This principle will affect the way many classes and objects relate to one another.','1552980250.jpeg',53),(15,'Scope Resolution Operator (::)','The Scope Resolution Operator (also called Paamayim Nekudotayim) or in simpler terms, the double colon, is a token that allows access to static, constant, and overridden properties or methods of a class.','1552980300.jpeg',53),(16,'dfsfd','fdsfdsf','1553024527.jpeg',53),(17,'new post','text','1553024712.jpeg',53),(18,'hhhv','hgcgjh kjnhjgh','1553026789.png',53),(19,'t4t4','45t45t','1553030138.jpeg',53),(20,'00000','000000000000000000000000000000000000000000000000','1553031658.jpeg',53),(21,'aaaa','bbbbbb','1553031716.jpeg',53),(22,'Traits','Traits are a mechanism for code reuse in single inheritance languages such as PHP. A Trait is intended to reduce some limitations of single inheritance by enabling a developer to reuse sets of methods freely in several independent classes living in different class hierarchies.','1553065550.jpeg',53),(23,'Traits','A Trait is similar to a class, but only intended to group functionality in a fine-grained and consistent way. It is not possible to instantiate a Trait on its own. It is an addition to traditional inheritance and enables horizontal composition of behavior; that is, the application of class members without requiring inheritance.','1553065569.jpeg',53),(24,'Traits','An inherited member from a base class is overridden by a member inserted by a Trait. The precedence order is that members from the current class override Trait methods, which in turn override inherited methods.','1553065597.jpeg',53),(25,'Traits','An inherited method from a base class is overridden by the method inserted into MyHelloWorld from the SayWorld Trait. The behavior is the same for methods defined in the MyHelloWorld class. The precedence order is that methods from the current class override Trait methods, which in turn override methods from the base class.','1553065620.jpeg',53),(26,'Traits','Multiple Traits can be inserted into a class by listing them in the use statement, separated by commas.','1553065688.jpeg',53),(27,'Traits','In this example, Talker uses the traits A and B. Since A and B have conflicting methods, it defines to use the variant of smallTalk from trait B, and the variant of bigTalk from trait A.\r\n\r\nThe Aliased_Talker makes use of the as operator to be able to use B\'s bigTalk implementation under an additional alias talk.','1553065708.png',53);
...
INSERT INTO `registration` VALUES (1,'htyty','kjnjnkjn','account.png','xx@gmail.com','3d186804534370c3c817db0563f0e461'),(2,'Siv','Dav','account.png','sivdav@mail.ru','4297f44b13955235245b2497399d7a93'),(3,'dgreger','dfggr','account.png','a@mail.ru','c8837b23ff8aaa8a2dde915473ce0991'),(4,'a','b','account.png','ab@mail.ru','594f803b380a41396ed63dca39503542'),(5,'Siv','Dav','account.png','sivdav@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(6,'Siv','Dav','account.png','sivdav@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(7,'Siv','Dav','account.png','sivdav@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(8,'Siv','Dav','account.png','sivdav@gmail.com','e10adc3949ba59abbe56e057f20f883e'),(9,'Siv','Dav','account.png','sivdav@gmail.com','de872154ffbf91a5dcc0e539dd2d5106'),(10,'dfsdfsdf','df sffs','account.png','xx@gmail.com','eb89f40da6a539dd1b1776e522459763'),(11,'nghnghngh','gfghfhfh','account.png','asd@mail.ru','95ebc3c7b3b9f1d2c40fec14415d3cb8'),(12,'nghnghngh','gfghfhfh','account.png','asd@mail.ru','95ebc3c7b3b9f1d2c40fec14415d3cb8'),(13,'qwe','qwe','account.png','qwe@mail.ru','26fe0cdfe99bfa306e31733c4e2b17dc'),(14,'qwe','qwe','account.png','qwe@mail.ru','26fe0cdfe99bfa306e31733c4e2b17dc'),(15,'qwe','qwe','account.png','qwe@mail.ru','1c5612408172b6b3fd77f0210a0cfd98'),(16,'qwe','qwe','account.png','qwe@mail.ru','26fe0cdfe99bfa306e31733c4e2b17dc'),(17,'a','','account.png','hjhbh@mail.ru','dcddb75469b4b4875094e14561e573d8'),(18,'a','','account.png','hjhbh@mail.ru','dcddb75469b4b4875094e14561e573d8'),(19,'ddd','','account.png','asd@mail.ru','dcddb75469b4b4875094e14561e573d8'),(20,'','frfer','account.png','poi@mail.ru','fbfeb7f1f5730254fbdd84ad458eacbf'),(21,'new','new2','account.png','new@mail.ru','800e365301349f2b62fc5bcbf6ac2b39'),(22,'cbjhsbjsdhb','dcjbdch','account.png','a@gmail.ru','de872154ffbf91a5dcc0e539dd2d5106'),(23,'user Name','user Surname','account.png','user@gmailcom','827ccb0eea8a706c4c34a16891f84e7b'),(24,'user name','user Surname','account.png','user@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(25,'user Name','user Surname','account.png','user@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(26,'user name','user Surname','account.png','user@mail.ru','e10adc3949ba59abbe56e057f20f883e'),(27,'user Name','user Surname','account.png','user@mail.ru','e10adc3949ba59abbe56e057f20f883e');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-02-17 15:18:29',NULL),('diagnostics.include_raw','OFF','2019-02-17 15:18:29',NULL),('ps_thread_trx_info.max_length','65535','2019-02-17 15:18:29',NULL),('statement_performance_analyzer.limit','100','2019-02-17 15:18:29',NULL),('statement_performance_analyzer.view',NULL,'2019-02-17 15:18:29',NULL),('statement_truncate_len','64','2019-02-17 15:18:29',NULL);
...
CREATE TABLE `task` (
  ...
  `l_name` varchar(105) NOT NULL,
  `e_mail` varchar(105) NOT NULL,
...
INSERT INTO `task` VALUES (1,'cxvxcv','xcvxcv','a@gmail.ru','123123',''),(2,'cxvxcv','xcvxcv','a@gmail.ru','123321',''),(3,'cxvxcv','xcvxcv','a@gmail.ru','123321',''),(4,'dvdfv','jhbhjbhj','a@gmail.ru','123321',''),(5,'deewe','wefef','a@gmail.ru','123321',''),(6,'glukg','g,ukugy','user@mail.ru','111111',''),(7,'jkhjk','hjkhjkhj','a@gmail.ru','111111',''),(8,'dsfsdf','sdfsdf','a@gmail.ru','sdfsdf',''),(9,'rfrerer','jhhvghv','a@gmail.ru','456456',''),(10,'Narek','Vardanyan','admin@admin.com','adminadmin',''),(11,'fddfg','dfgdfg','a@gmail.ru','321321',''),(12,'eert','jhhg','a@gmail.ru','321321',''),(13,'tgrtrgrtg','ffef','a@gmail.ru','321321',''),(14,'referf','ghfh','a@gmail.ru','123123',''),(15,'dsdsfsdfds','hgghfgh','b@mail.ru','123123',''),(16,'dffg','gghgh','jhghg@mail.ru','321123',''),(17,'dgdfg','ddfsd','dfsdf@mail.ru','654654',''),(18,'name1','surname2','name@mail.ru','123321',''),(19,'name2','surname3','sipadavtyan@gmail.com','321321',''),(20,'dfdvdfv','fvdfvdf','qwe@mail.ru','321321',''),(21,'fvdfvdf','fdvdfv','asd@mail.ru','321321',''),(22,'cxcv','tftf','as@mail.com','321321',''),(23,'dsdsd','sdfsdf','sa@mail.ru','321321',''),(24,'hgy','jhj','m@mail.ru','321321',''),(25,'rgerg','hvhvhv','w@mail.ru','654654',''),(26,'User Name','User Surname','user@gmail.com','987987',''),(27,'User Name2','User Surname2','username@mail.ru','789789',''),(28,'User Name2','User Surname2','username2@mail.ru','654654',''),(29,'sxss','asas','asas@mail.ru','321321',''),(30,'name1','','','1233',''),(31,'name1','','','1233',''),(32,'name1','','','1234',''),(33,'name1','','','1231',''),(34,'name1','surname1','username1@mail.ru','1233',''),(35,'user1','surnem1','usersurname@gmail.com','7899',''),(36,'name1','surname1','789@mail.ru','321321','36 ..'),(37,'Gor','Sirekenyan','gorsirekanyan1@gmail.com','test66','user.png'),(38,'user name','user surname','useremail@mail.ru','654987','user.png'),(39,'54546546','000','aaaaaa@gmail.com','333333','39.png'),(40,'Angelina','Vardanyan','angelinavardanyan01@gmail.ru','kaxamb96','40.jpeg'),(41,'Narek','Vardanyan','na@mail.ru','321321','41.png'),(42,'aaaaaaa','bbbbbbbb','check@mail.ru','654654','42.png'),(43,'test','testsurname','test@mail.ru','987987','user.png'),(44,'test2','check2','test@gmail.ru','987987','user.png'),(45,'css','css tutorial','css@gmail.com','css123','45.png'),(46,'dscsdc','hghgh','lil@mail.ru','lili','user.png'),(47,'bhhjbhj','gfff','ki@mail.ru','987987','user.png'),(48,'jhghg','fdeed  e','kl@mail.ru','321321','user.png'),(49,'vgghvg\'\' \'hbjhj','vhgvgvgh','kr@m.ru','321321','user.png'),(50,'gvgv \'\'h\'\'bg/','hbjhbj','lo@m.ru','321321','user.png'),(51,'','sdcdc','f@a.ru','321321','user.png'),(52,'uyuy','hghjg','z@m.ru','321321','52.jpeg'),(53,'/php/','php123546fgfdgd','php@gmail.com','php123','53.png'),(54,'Lorem13','check2','rgfddfqwe@mail.ru','123456','54.jpeg');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='users';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (42,'new user11','ner sername11','42.png','new@mail.ru','321321'),(43,'John new','Doe new','43.png','john@mail.ru','321321'),(44,'user','surname','3.png','a@m.ru','321321'),(45,'asdasds','sdfsdfds','3.png','a@g.ru','321321'),(46,'new user','new surname','3.png','new@m.ru','321321'),(47,'test_f','test_t','3.png','test@test.ru','1234'),(48,'John new','Doe new','48.jpeg','a@m.com','new123'),(49,'Raz','Raz','49.png','razmiksghoyan@gmail.com','123456aaa'),(50,'gg','fdfdf','3.png','s@m.ru','000000'),(51,'hggy','gfdfdf','3.png','q@m.ru','987987'),(52,'vggf','fdxdx','3.png','w@m.ru','321321'),(53,'Sirarpi','Davtyan','3.png','sipadavtyan@gmail.com','admin321321');
...
-- Dump completed on 2019-03-21 11:18:11
