                                    ...
                                    <div class="inner-post">
                                            ...
                                            <div class="post-info">
                                                <div class="post-title">
                                                    <h3><a href="blog-details.php"><?= $posts[1]; ?></a></h3>
                                                </div>
                        ...
                        <div class="single-widget profile-widget box-shadow">
                            <div class="widget-inner text-center">
                                <div class="profile-img">
                                    <a href="#"> <img src="../public/images/user/<?= $user[3]; ?>" alt="profile"></a>
                                </div>
                                <div class="profile-name">
                                    <h3><a href="profile.php"><?= $user[1]; ?></a></h3>
                                    <h3><a href="profile.php"><?= $user[2]; ?></a></h3>
                            ...
                            <div class="widget-inner">
                                ...
                                <nav class="navbar navbar-light bg-light">
                                    <form class="form-inline" method="post" action="searchResults.php">
                                        <input name="search" class="form-control mr-sm-4" type="search"
                                               placeholder="Search"
                                               aria-label="Search">
                                        <button class="btn btn-outline-primary my-2 my-sm-0">Search
                                        </button>
                                    </form>
                                </nav>
                            </div>
